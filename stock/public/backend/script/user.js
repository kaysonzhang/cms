new Vue({
    ...
    methods: {
        stockList() {
            ...
            param.append('phone', this.formInline.phone);
            param.append('nick_name', this.formInline.nick_name);
            ...
            axios.post(connect_url + '/backend/user/getUser', param)
                .then((response) => {
                    ...
                    if (jdata.code == 200) {
                        ...
                        _this.form.nick_name = jdata.data.nick_name;
        ...
        handleResetPass(id){
            ...
            let param = new FormData()
            param.append('id', id);
            this.$confirm('此操作将永重置密码, 是否继续?', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(() => {
                axios.post(connect_url + '/backend/user/resetpass', param)
                    .then((response) => {
                        let jdata = response.data;
                        if (jdata.code == 200) {
                            _this.$message({
        ...
        onPost() {
            ...
            param.append('nick_name', this.form.nick_name);
